...
export default function Footer() {
	return (
		<footer className="mt-10 py-10 border-t border-gray-300">
			...
			<div className="text-center space-y-3">
				...
				{/* Phone */}
				<div className="flex items-center justify-center gap-2 text-gray-700 text-sm tracking-wide">
			...
			<div className="flex justify-center gap-6 mt-6">
				<a
					...
					className="text-gray-700 hover:text-black transition-all hover:scale-110"
				>
